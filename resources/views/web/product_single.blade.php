                  ...
                  <div class="product_show">
                     <div id="carouselExampleIndicators" class="carousel" data-bs-touch="false" data-bs-interval="false" data-bs-ride="carousel">
                        <div class="carousel-indicators">
                          <button type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="0" class="active" aria-current="true" aria-label="Slide 1"><img src="{{asset('assets/web/img/product_img11.png')}}" alt=""></button>
                          <button type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="1" aria-label="Slide 2"><img src="{{asset('assets/web/img/product_img12.png')}}" alt=""></button>
                          <button type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="2" aria-label="Slide 3"><img src="{{asset('assets/web/img/product_img10.png')}}" alt=""></button>
                          <button type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="3" aria-label="Slide 4"><img src="{{asset('assets/web/img/product_img9.png')}}" alt=""></button>
                        </div>
                        <div class="carousel-inner">
                           <div class="carousel-item active">
                              <div class="productimg_show">
                                 <img src="{{asset('assets/web/img/product_img11.png')}}" class="d-block" alt="...">
                              </div>
                           </div>
                           <div class="carousel-item">
                              <div class="productimg_show">
                                 <img src="{{asset('assets/web/img/product_img12.png')}}" class="d-block" alt="...">
                              </div>
                           </div>
                           <div class="carousel-item">
                              <div class="productimg_show">
                                 <img src="{{asset('assets/web/img/product_img10.png')}}" class="d-block" alt="...">
                              </div> 
                           </div>
                           <div class="carousel-item">
                              <div class="productimg_show">
                                 <img src="{{asset('assets/web/img/product_img9.png')}}" class="d-block" alt="...">
                              </div> 
                           </div>
                        </div> 
                      </div>
                  ...
                  <div class="product_details_main ps-lg-5">
                     <div class="row align-items-start">
                           ...
                           <div class="product_details_text">
                              <div class="row border-bottom pb-4">
                                 ...
                                 <div class="col-12 quantity_box d-md-flex align-items-center mt-md-3">
                                    ...
                                    <a class="d-inline-block btn_main" href="{{url('checkout')}}">Buy Now</a>
                                 </div>
                              </div> 
                                          ...
                                          <div class="row align-items-start">
                                             <div class="col-auto py-2">
                                                <span class="offer_icon">
                                                   <img src="{{asset('assets/web/img/offers.png')}}" alt="">
                                                </span>
                                             </div>
                        ...
                        <div class="col-auto product_details_btns">
                           ...
                           <a class="ms-md-3 ms-1" href="javscript:;"><img src="{{asset('assets/web/img/share.png')}}" alt=""></a>
                        </div>
                     </div>
                  </div>
               </div>
