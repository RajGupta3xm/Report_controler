...
(function() {
  ...
  $(document).ready(function () {
      $('.onclk').on('click', function () { 
         $('.search_show_tables th').toggleClass('show_filter');  
      })
      $('.onclk1').on('click', function () { 
         $('.search_show_tables1 th').toggleClass('show_filter1');  
      })
      $('.onclk2').on('click', function () { 
         $('.search_show_tables2 th').toggleClass('show_filter2');  
      })
   });
